...
Modified by mkaar@sei.cmu.edu to add value templating
*/}}
...
{{- coalesce (tpl .Values.existingSecret .) (include "common.names.fullname" .) -}}
{{- end -}}
...
{{- if .Values.postgresql.enabled }}
    ...
    {{- end -}}
{{- else -}}
    {{- print (tpl .Values.externalDatabase.host .) -}}
{{- end -}}
{{- end -}}
